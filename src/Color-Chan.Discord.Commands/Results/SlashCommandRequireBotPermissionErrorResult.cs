...
{
    /// <summary>
    ///     An error result describing an error for <see cref="SlashCommandRequireBotPermissionAttribute"/> when the bot did not meet the permission requirements.
    /// </summary>
    public record SlashCommandRequireBotPermissionErrorResult : SlashCommandRequirementErrorResult
    {
        ...
        /// <param name="missingPermissions">The missing <see cref="DiscordGuildPermission"/>s the bot was required to have for this command/command group.</param>
