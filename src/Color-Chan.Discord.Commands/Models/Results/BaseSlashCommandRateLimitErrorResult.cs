...
namespace Color_Chan.Discord.Commands.Models.Results
{
    ...
    /// </summary>
    public record BaseSlashCommandRateLimitErrorResult : SlashCommandRequirementErrorResult
    {
        /// <summary>
        ///     Initializes a new instance of <see cref="BaseSlashCommandRateLimitErrorResult" />.
        /// </summary>
        ...
        internal BaseSlashCommandRateLimitErrorResult(string errorMessage, int max, DateTimeOffset absoluteExpiration) : base(errorMessage)
        {
            Max = max;
