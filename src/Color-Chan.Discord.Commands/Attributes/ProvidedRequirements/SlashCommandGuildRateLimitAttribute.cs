...
namespace Color_Chan.Discord.Commands.Attributes.ProvidedRequirements
{
    ...
    /// </summary>
    /// <remarks>
    ///     This requirement will limit the amount of time all the users in a guild can request a slash command during a time
    ///     period.
    /// </remarks>
    /// <example>
    ...
    ///     <see cref="SlashCommandGuildRateLimitAttribute" /> on a method if
    ///     you
