...
/// <inheritdoc />
public class DiscordPartialChannel : IDiscordPartialChannel
{
    /// <summary>
    ///     Initializes a new <see cref="DiscordPartialChannel"/>
    /// </summary>
    /// <param name="data">The data needed to create the <see cref="DiscordPartialChannel"/>.</param>
    public DiscordPartialChannel(DiscordPartialChannelData data)
    {
        Id = data.Id;
        Type = data.Type;
